...
function activate(context) {
    context.subscriptions.push(vscode.commands.registerCommand('kyb.start', () => {
        kyb.createOrShow(context.extensionUri);
    }));
    context.subscriptions.push(vscode.commands.registerCommand('kyb.doRefactor', () => {
        if (kyb.currentPanel) {
...
class kyb {
    ...
    static createOrShow(extensionUri) {
        ...
        const panel = vscode.window.createWebviewPanel(kyb.viewType, 'kyb', column || vscode.ViewColumn.One, getWebviewOptions(extensionUri));
